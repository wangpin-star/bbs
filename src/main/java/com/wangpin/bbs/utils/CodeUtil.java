...
import com.wangpin.bbs.BbsApplication;
...
public class CodeUtil {
    ...
    public static void main(String[] args) throws Exception {
        //创建文件输出流对象
        OutputStream out = new FileOutputStream(System.getProperty("user.dir")+"/src/main/resources/"+System.currentTimeMillis()+".jpg");
